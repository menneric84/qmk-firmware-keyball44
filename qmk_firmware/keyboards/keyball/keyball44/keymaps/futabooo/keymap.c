...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    CTL_T(KC_GRV)        , KC_EXLM  , KC_AT    , KC_HASH  , KC_DLR      , KC_PERC  ,                                   KC_CIRC  , KC_AMPR     , KC_ASTR  , KC_MINS     , KC_EQL     , RCTL_T(KC_BSLS)    ,
    S(KC_GRV)            , XXXXXXX  , XXXXXXX  , KC_LBRC  , S(KC_LBRC)  , KC_LPRN  ,                                   KC_RPRN  , S(KC_RBRC)  , KC_RBRC  , S(KC_MINS)  , S(KC_EQL)  , S(KC_BSLS)         ,
